# -*- coding: utf-8 -*-
"""
Created on  十一月 18 2:00 2017

@author: aeloyq
"""

import theano.tensor as T
from theano.scan_module.scan import *
...
def scan(fn_wrapper,
    ...
    out_size_list, out_attr_list, o = fn_wrapper(fn, args)
    condition, outputs, updates = scan_utils.get_updates_and_outputs(o)
    ...
    if len(scan_out_list) == 1:
        ...
        scan_out_list = None
    return (out_size_list, out_attr_list, scan_out_list, update_map)
